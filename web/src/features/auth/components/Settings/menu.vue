...
<template>
    ...
    <!-- <SettingsMenu>
        <SettingsMenuItem>Food</SettingsMenuItem>
        <SettingsMenuItem>Entertainment</SettingsMenuItem>
        <SettingsMenuItem>Blog</SettingsMenuItem>
        <SettingsMenuItem>Location</SettingsMenuItem>
        <SettingsMenuItem>Location</SettingsMenuItem>
        <SettingsMenuItem>Location</SettingsMenuItem>
        <SettingsMenuItem>Location</SettingsMenuItem>
        <SettingsMenuItem>Location</SettingsMenuItem>
...
.inp:not(:checked)~.menu-container {
    .menu-list {
        ...
        @for $i from 1 through $total-items {
            &:nth-child(#{$i}) {
                transition: transform 0.4s calc(var(--delay) + (var(--trdelay) * #{$i - 1})),
                opacity 0.4s calc(var(--delay) + (var(--trdelay) * #{$i - 1}));
            }
        }
    }
}

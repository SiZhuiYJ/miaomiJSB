<template>
    <div class="kaomoji-wrapper">
        <div class="kaomoji-container" ref="containerRef"><!-- 1. 缩小颜色跨度：偏移量乘数从 20 降到 6，让相邻字符颜色更接近 -->
...
.char {
    ...
    /* 调整为更柔和的粉彩色调（降低饱和度至 85%，提高亮度至 78%）以贴合原图风格 */
